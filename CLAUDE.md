...
- Den has its own explicitly selected burst/recovery policy and measured-range controller. Preserve the two-hour manual hold, fault latch, independent driver, overlap handling and verified startup reference. Do not apply den calibration or policy changes to the bedroom.
